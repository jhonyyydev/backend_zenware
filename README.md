...
* Usar Bean Validation para asegurar el tipo y formato de los datos recibidos en los endpoints REST.
* Capturar esta excepción y devolver un mensaje de error claro al cliente.
* Implementar validaciones en el front-end o cliente para evitar enviar datos inválidos.
...
* Usaría **EC2** cuando necesito control total sobre el servidor, procesos de larga duración o configuraciones personalizadas.
* Usaría **Lambda** para tareas pequeñas, rápidas y event-driven que no requieren mantener servidores siempre activos.
...
Si tienen alguna duda o requieren que amplíe alguna sección, quedo atento.
